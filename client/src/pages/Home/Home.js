              ...
              <div className="hero-inner">
                <div className="hero-copy">
                  <h2 className="hero-title mt-0">
                    MemCAM - Capture your Memories and Adventures
                  </h2>
                ...
                <div className="features-header text-center">
                  <div className="container-sm">
                    ...
                    <p className="section-paragraph">
                      MemCAM is a platform that allows you create memories for
                      private or public and also reads other awesome adventurous
                      memory.
                    </p>
                  </div>
                </div>
