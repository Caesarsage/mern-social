...
import { TextField, Button, Typography, Paper, Checkbox, RadioGroup, Radio, FormControlLabel, FormLabel } from "@material-ui/core";
      ...
      >
        ...
        <div>
          ...
          <RadioGroup
            ...
            onChange={(e) =>
              setPostData({ ...postData, isPrivate: e.target.value === 'false' ? false : true })
            }
          >
            <FormControlLabel
              value='false'
